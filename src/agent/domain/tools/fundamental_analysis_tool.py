...
class FundamentalAnalysisTool(CustomBaseTool):
    ...
    SUPPORTED_METRICS: ClassVar[List[str]] = [
        "pe", "pb", "roe", "eps", "market_cap", "revenue", "profit", "debt_ratio",
        "current_ratio", "quick_ratio", "gross_margin", "net_margin", "roa"
    ]
    ...
    async def _execute_impl(
        self,
        symbols: Union[str, List[str]]    ) -> Dict[str, Any]:
        ...
        try:
            ...
            fundamental_data = await self._provider.get_fundamental_ratios(normalized_symbols)
