...
class InMemorySessionManager:
    ...
    async def update_conversation(self, session_id: str, message: Dict[str, Any]):
    ...
    async def get_cached_analysis(self, session_id: str, query_hash: str, cache_ttl: int = 300) -> Optional[Dict[str, Any]]:
    ...
    async def _cleanup_expired_sessions(self):
        ...
        async with self._lock:
            for session_id, session_data in self.sessions.items():
                if current_time - session_data.last_accessed > self.default_ttl:
