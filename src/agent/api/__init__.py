...
from .dependencies.service import initialize_services, cleanup_services
...
async def lifespan(app: FastAPI):
    ...
    # Initialize services
    logger.info("Initializing global services (Redis session manager and ServiceManager)...")
